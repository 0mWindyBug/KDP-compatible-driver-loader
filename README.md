...
# Notes
- in case loading gdrv.sys fails, its likely due to Microsoft's driver blocklist. just modify the code tk use an alternative driver , there are plenty of them.     
